...
class _BookyourAppointmentState extends State<BookyourAppointment> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SpecialitiesController>(
        builder: (cont) {
          return SpecialitiesController.i.isLoading == false ? SafeArea(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: ListTile(
                              onTap: () async{
                                log('over here');
                              List<Search> search =  await SpecialitiesController.i.getDoctors(doctor.id!);
                                Get.to(()=> Specialists(doctors: search, title: doctor.name,));
                              },

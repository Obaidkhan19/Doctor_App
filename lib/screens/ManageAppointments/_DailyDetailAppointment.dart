      ...
      return Padding(
        ...
        child: Column(
          children: [
            ...
            Container(
              height: MediaQuery.sizeOf(context).width < 460
                  ? Get.height * 0.12
                  : Get.height * 0.25,
              ...
              child: DatePicker(
                ...
                initialSelectedDate:
                    ManageAppointmentController.i.date ?? DateTime.now(),
                selectionColor: ColorManager.kPrimaryColor,
                selectedTextColor: Colors.white,
                onDateChange: (date) {
                  String Date = DateFormat('yyyy-MM-dd').format(date);
                  SelectedDate = Date;
                  ManageAppointmentController.i.getDailyDoctorAppointmentSlots(
                      Date.toString(),
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: () {
                    List<Appointments> result = ManageAppointmentController.i
                          ...
                          builder: (BuildContext context) {
                            return CustomDialog_DatePicker(
                              ...
                              onPressed: () async {
                                ...
                                var response = await ManageAppointmentController
                                    .i
                                    .reShedualAppointmentSlots(
                                        dateReshedualcontroller.text.toString(),
                    ...
                    if (result.isEmpty) {
                      showDialog(
                          ...
                          builder: (BuildContext context) {
                            return CustomDialog(
                              title: 'error'.tr,
                              content: 'nopendingappointmentisselected'.tr,
                              footer: 'ok'.tr,
                              onClosePressed: () {
                                // print('Dialog closed');
                              },
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: (ManageAppointmentController.i.selectall ==
                                      true)
                                  ? Icon(Icons.check,
            ...
            if ((((ManageAppointmentController
                            .i.dayViewAppointmentSlotModel.appointments !=
                        null))
              ...
              BlurryModalProgressHUD(
                inAsyncCall: contr.isLoadingDailyDoctorAppointmentSlots,
                                                                ...
                                                                ? InkWell(
                                                                    onTap: () {
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        ManageAppointmentController
                                                                            .i
                                                                            .updateCheckedBoxStatus(manageAppointmentSlots.appointmentId!);
                                                                        //   isChecked = !isChecked;
                                                                      });
                                                                    },
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          border:
                                                                              Border.all(color: (manageAppointmentSlots.status.toString().toLowerCase().contains('confirmed')) ? Colors.green : Colors.black), // Border color
                                                                          borderRadius:
                                                                              BorderRadius.circular(4), // Adjust as needed
                                                                        ),
                                                                        child: (manageAppointmentSlots.IsChecked ==
                                                                                true)
                                                                            ? Icon(Icons.check,
                                                                                size: 16,
                                                                                color: (manageAppointmentSlots.status.toString().toLowerCase().contains('confirmed')) ? Colors.green : Colors.black) // Show the check icon when checked
                                                                            : Container(), // No content when not checked
                                                                      ),
                                                                    ),
                                                                  )

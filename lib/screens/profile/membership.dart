                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: Get.width * 0.24,
                                    child: Text(
                                      ProfileController.i.membershipList[index]
                                              .organizationName ??
                                          "",
                                      style: GoogleFonts.poppins(
                                        fontSize: 11,
                                  ...
                                  SizedBox(
                                      width: Get.width * 0.2,
                                      child: Text(
                                        "${(ProfileController.i.membershipList[index].fromDate != null) ? DateFormat('MM-dd-y').format(DateTime.parse(ProfileController.i.experienceList[index].fromDate!.split("T")[0])) : "-"} ${" To "} ${(ProfileController.i.membershipList[index].fromDate != null) ? DateFormat('MM-dd-y').format(DateTime.parse(ProfileController.i.membershipList[index].toDate!.split("T")[0])) : "-"}  ",
                                        style: GoogleFonts.poppins(
                                          fontSize: 11,
                                          color: ColorManager.kWhiteColor,
                                        ),

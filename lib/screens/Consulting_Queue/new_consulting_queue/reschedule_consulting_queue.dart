...
class RescheduleConsultingQueueScreen extends StatefulWidget {
  const RescheduleConsultingQueueScreen({super.key});

  @override
  State<RescheduleConsultingQueueScreen> createState() =>
      _RescheduleConsultingQueueScreenState();
}

class _RescheduleConsultingQueueScreenState
    extends State<RescheduleConsultingQueueScreen> {
  @override

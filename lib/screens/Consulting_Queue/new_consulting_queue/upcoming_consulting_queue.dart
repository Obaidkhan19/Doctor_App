...
class UpcomingConsultingQueueScreen extends StatefulWidget {
  const UpcomingConsultingQueueScreen({super.key});

  @override
  State<UpcomingConsultingQueueScreen> createState() =>
      _UpcomingConsultingQueueScreenState();
}

class _UpcomingConsultingQueueScreenState
    extends State<UpcomingConsultingQueueScreen> {
  @override

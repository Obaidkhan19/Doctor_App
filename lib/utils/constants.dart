...
class AppConstants {
  // Base Url
  static  String testing = 'http://192.168.88.254:324'; // for testing QA



  // static  String baseURL = 'https://patient.helpful.ihealthcure.com';
  ...
  static  String getSubSpecialities =
  ...
  static  String usernameavaibility =
...
// eRX APIS
  ...
  static  String getInvestigations =
  ...
  static  String getMedicinesMatrix =
      "$baseURL/api/doctor/GetMedicineMatrix";
  static  String getErnsHistory =
  ...
  static  String consultingqueuepatient =
